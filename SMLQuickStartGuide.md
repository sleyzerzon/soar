#summary Getting started with SML integration.
...
A WME's value can be updated through the `pAgent->Update()` method and it can
...
Based on these flags, the environment should decide whether to update or not.
