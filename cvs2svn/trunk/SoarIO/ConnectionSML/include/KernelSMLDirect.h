...
typedef Direct_WME_Handle			(*DirectAddWMEStringFunction)(Direct_WorkingMemory_Handle, Direct_WMObject_Handle, char const*, char const*) ;
typedef Direct_WME_Handle			(*DirectAddWMEIntFunction)(Direct_WorkingMemory_Handle, Direct_WMObject_Handle, char const*, int) ;
typedef Direct_WME_Handle			(*DirectAddWMEDoubleFunction)(Direct_WorkingMemory_Handle, Direct_WMObject_Handle, char const*, double) ;
typedef void						(*DirectRemoveWMEFunction)(Direct_WorkingMemory_Handle, Direct_WME_Handle) ;

typedef Direct_WME_Handle			(*DirectAddIDFunction)(Direct_WorkingMemory_Handle, Direct_WMObject_Handle, char const*) ;
typedef Direct_WME_Handle			(*DirectLinkIDFunction)(Direct_WorkingMemory_Handle, Direct_WMObject_Handle, char const*, Direct_WMObject_Handle) ;
...
typedef void						(*DirectRunFunction)(char const*, bool, int, int) ;
