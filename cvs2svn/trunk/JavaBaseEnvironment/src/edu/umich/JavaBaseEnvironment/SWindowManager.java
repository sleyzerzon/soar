...
public class SWindowManager implements SimulationControlListener, WorldCountNotificationListener{
	 ...
	 */
	public SWindowManager(SimulationControl sc, boolean agentWindowsOn, boolean mapWindowOn, boolean controlPanelOn,boolean disablePopups,String taskIn, String taskNounIn, String extIn, String extDesIn){
		mySC = sc;
