 ...
 */
package edu.umich.robot.util.swing;
...
public class SwingTools
{
    ...
    /**
     * May be called to set a split pane's proportional divider location before
     * the split pane is displayed. Uggh.
     * 
     * @param split
     *            the split pane
     * @param location
     ...
     */
    public static void setDividerLocation(final JSplitPane split,
    ...
    {
        addSelectAllOnFocus((JTextComponent) combo.getEditor()
                .getEditorComponent());
    }
