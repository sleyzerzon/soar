...
|_____|_| |_|\__,_|_| |_| |_|_| \_\___|_| |_| |_|\__,_| .__/| .__/|_|_| |_|\__, |___/
   ...
   */
   void EnumRemappings::Init(void)
   {
      ...
      PhaseTypeEnumMapping[INPUT_ELAB_PHASE]    = gSKI_INPUT_ELAB_PHASE;
      PhaseTypeEnumMapping[DECISION_PHASE]      = gSKI_DECISION_PHASE;
      PhaseTypeEnumMapping[DECISION_ELAB_PHASE] = gSKI_DECISION_ELAB_PHASE;
      PhaseTypeEnumMapping[APPLY_PHASE]         = gSKI_APPLY_PHASE;
      PhaseTypeEnumMapping[APPLICATION_ELAB_PHASE]    = gSKI_APPLICATION_ELAB_PHASE;
      ...
      RunEventEnumMapping[BEFORE_INPUT_ELAB_PHASE_CALLBACK]  = gSKIEVENT_BEFORE_INPUT_ELAB_PHASE;
      RunEventEnumMapping[BEFORE_DECISION_PHASE_CALLBACK] = gSKIEVENT_BEFORE_DECISION_PHASE;
      RunEventEnumMapping[BEFORE_DECISION_ELAB_PHASE_CALLBACK]  = gSKIEVENT_BEFORE_DECISION_ELAB_PHASE;
      RunEventEnumMapping[BEFORE_APPLY_PHASE_CALLBACK]	  = gSKIEVENT_BEFORE_APPLY_PHASE;
      RunEventEnumMapping[BEFORE_APPLICATION_ELAB_PHASE_CALLBACK]  = gSKIEVENT_BEFORE_APPLICATION_ELAB_PHASE;
      ...
      RunEventEnumMapping[AFTER_INPUT_ELAB_PHASE_CALLBACK]   = gSKIEVENT_AFTER_INPUT_ELAB_PHASE;
      RunEventEnumMapping[AFTER_DECISION_PHASE_CALLBACK]  = gSKIEVENT_AFTER_DECISION_PHASE;
      RunEventEnumMapping[AFTER_DECISION_ELAB_PHASE_CALLBACK]   = gSKIEVENT_AFTER_DECISION_ELAB_PHASE;
      RunEventEnumMapping[AFTER_APPLY_PHASE_CALLBACK]	  = gSKIEVENT_AFTER_APPLY_PHASE;
      RunEventEnumMapping[AFTER_APPLICATION_ELAB_PHASE_CALLBACK]   = gSKIEVENT_AFTER_APPLICATION_ELAB_PHASE;
  ...
  **/
   ...
   */
   ...
   /** this goes from gSKI to Kernel native callbacks **/
   {
	  ...
	  case gSKIEVENT_BEFORE_INPUT_ELAB_PHASE:		  return BEFORE_INPUT_ELAB_PHASE_CALLBACK;
	  case gSKIEVENT_BEFORE_DECISION_PHASE:			  return BEFORE_DECISION_PHASE_CALLBACK;
	  case gSKIEVENT_BEFORE_DECISION_ELAB_PHASE:	  return BEFORE_DECISION_ELAB_PHASE_CALLBACK;
	  case gSKIEVENT_BEFORE_APPLY_PHASE:			  return BEFORE_APPLY_PHASE_CALLBACK; 
	  case gSKIEVENT_BEFORE_APPLICATION_ELAB_PHASE:	  return BEFORE_APPLICATION_ELAB_PHASE_CALLBACK;
	  ...
	  case gSKIEVENT_AFTER_INPUT_ELAB_PHASE:		  return AFTER_INPUT_ELAB_PHASE_CALLBACK;
	  case gSKIEVENT_AFTER_DECISION_PHASE:			  return AFTER_DECISION_PHASE_CALLBACK;
	  case gSKIEVENT_AFTER_DECISION_ELAB_PHASE:		  return AFTER_DECISION_ELAB_PHASE_CALLBACK;
	  case gSKIEVENT_AFTER_APPLY_PHASE:				  return AFTER_APPLY_PHASE_CALLBACK;
	  case gSKIEVENT_AFTER_APPLICATION_ELAB_PHASE:	  return AFTER_APPLICATION_ELAB_PHASE_CALLBACK;
