...
bool CommandLineInterface::ParseExploration(gSKI::Agent* pAgent, std::vector<std::string>& argv) {
	Options optionsData[] = {
		{'m',"mode",					1},
		{'t',"temperature",             1},
		{'e',"epsilon",                 1},
...
bool CommandLineInterface::DoExploration(gSKI::Agent* pAgent, const int modeSetting, const double Temp, const double epsilon) {
