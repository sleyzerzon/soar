...
/********************************************************************
* @file igski_outputwmobject.h 
*********************************************************************
* created:	   6/13/2002   15:00
*
* purpose: 
*********************************************************************/
#ifndef GSKI_OUTPUTWMOBJECT_H
#define GSKI_OUTPUTWMOBJECT_H
...
namespace gSKI {
    ...
    *  the iterator pointing at them.  Releasing a OutputWMObject does not remove
    ...
    *  OutputWMObjects, the OutputWMObject does not go away until it is released (through
    ...
    *
    */
   class OutputWMObject: public RefCountedReleaseImpl<IWMObject, false> {
   public:
       ...
       *
       */
      OutputWMObject(OutputWorkingMemory* manager, Symbol* sym);
      ...
      * @brief
      */
     void AddReferencedWme(OutputWme* wme);
     void AddReferencedObject(OutputWMObject* obj, OutputWme* wme);
     void AddReferencingObject(OutputWMObject* obj, OutputWme* wme);
     void ReInitialize();
     OutputWorkingMemory* GetManager() { return m_manager; }
   ...
   private:
     ...
     std::vector<OutputWme*> m_vwmes;
     std::map<OutputWme*,OutputWMObject*> m_parentmap;
     std::map<OutputWme*,OutputWMObject*> m_childmap;

     typedef std::map<OutputWme*,OutputWMObject*>::iterator tWmeObjIt;
