...
namespace gSKI {
   ...
   */
   ...
   public:
      ...
      *           the function fails.
      */
      virtual Agent* AddAgent(const char*       name, 
      ...
      *
      */
      virtual void RemoveAgent(Agent* agent, Error* err = 0) = 0;
      ...
      */
      virtual Agent* GetAgent(const char* name, Error* err = 0) = 0;
      ...
      */
       ...
       *               information is not returned.
       */
      virtual void    AddAgentToRunList(Agent* agentToAdd, Error* err = 0) = 0;
       ...
       *               information is not returned.
       */
      virtual void      RemoveAgentFromRunList(Agent* agentToAdd, Error* err = 0) = 0;
