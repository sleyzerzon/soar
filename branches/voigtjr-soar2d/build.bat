...
@echo ----------=========Compiling=========----------
%2javac -source 1.5 -d tmp -classpath jdom.jar;%SOARBIN%\log4j-1.2.15.jar;%SOARBIN%\swt.jar;%SOARBIN%\sml.jar;%SOARBIN%\tosca.jar -sourcepath src src\soar2d\Soar2D.java
