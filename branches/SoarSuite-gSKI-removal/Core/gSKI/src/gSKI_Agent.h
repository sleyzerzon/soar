...
namespace gSKI
{
	...
	public:     
		...
		*  agent begins executing (assuming it is active, see Agent::SetActive)
	...
	public:
		...
		*/
		class RunNotifier {
		public:
			RunNotifier(Agent* a, egSKIPhaseType p): 
			  m_agent(a), m_phase(p){}
		...
		*/
		class XMLNotifier {
		public:
			XMLNotifier(Agent* a, const char* ft, const char* aOt, const char* v): 
		...
		*/
		class PrintNotifier {
		public:
			PrintNotifier(Agent* a, const char* msg): m_agent(a), m_msg(msg) {}
