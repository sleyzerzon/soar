...
void Handlers::MyDeletionHandler(sml::smlAgentEventId, void* pUserData, sml::Agent* pAgent)
{
	std::cout << std::endl << "MyDeletionHandler for agent " << pAgent->GetAgentName() << std::endl;
