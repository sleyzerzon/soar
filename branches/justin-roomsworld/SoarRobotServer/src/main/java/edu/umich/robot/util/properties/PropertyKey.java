...
/**
 * A PropertyKey is a unique identifier for a property. It includes the name of
 * the property, the type of its value and a default value. A PropertyKey is
 * immutable.
 * 
 * @author ray
 */
public class PropertyKey<T>
{
     ...
     * client code attempts to modify a readonly property. Note that the value
     * of the property may still change, just not externally.
     * 
