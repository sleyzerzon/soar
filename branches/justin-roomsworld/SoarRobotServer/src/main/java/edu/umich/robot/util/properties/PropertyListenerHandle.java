...
public class PropertyListenerHandle<T>
{
    ...
    /**
     * Construct a new handle. Only for use by PropertyManager. Assumes that the
     * listener is already added to the manager
     * 
     * @param manager
     *            the manager
     * @param key
    ...
    /**
     * Add the listener to the manager. Does nothing if the listener is already
     * added.
     * 
     * <p>
