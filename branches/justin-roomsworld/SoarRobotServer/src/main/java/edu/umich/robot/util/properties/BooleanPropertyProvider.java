 ...
 * {@link AtomicBoolean} to provide safe access to the value. This provider is
 * intended for use with flags that must be accessed frequently.
 * 
 * @author ray
 */
...
{
    /**
     * The current value. This value may be freely modified by owning code as
     * long as change events are not required.
     */
