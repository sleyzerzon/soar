...
bool CommandLineInterface::DoStats(const StatsBitset& options) {
	...
	AppendArgTagFast(sml_Names::kParamStatsWmeCountAverage,						sml_Names::kTypeDouble, lexical_cast< std::string >((m_pAgentSoar->num_wm_sizes_accumulated ? (m_pAgentSoar->cumulative_wm_size / m_pAgentSoar->num_wm_sizes_accumulated) : 0.0)).c_str());
	...
	AppendArgTagFast(sml_Names::kParamStatsKernelCPUTime,						sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->total_kernel_time)).c_str());
	AppendArgTagFast(sml_Names::kParamStatsTotalCPUTime,						sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->total_cpu_time)).c_str());
	AppendArgTagFast(sml_Names::kParamStatsPhaseTimeInputPhase,					sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->decision_cycle_phase_timers[INPUT_PHASE])).c_str()); 
	AppendArgTagFast(sml_Names::kParamStatsPhaseTimeProposePhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->decision_cycle_phase_timers[PROPOSE_PHASE])).c_str()); 
	AppendArgTagFast(sml_Names::kParamStatsPhaseTimeDecisionPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->decision_cycle_phase_timers[DECISION_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsPhaseTimeApplyPhase,					sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->decision_cycle_phase_timers[APPLY_PHASE])).c_str());  
	AppendArgTagFast(sml_Names::kParamStatsPhaseTimeOutputPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->decision_cycle_phase_timers[OUTPUT_PHASE])).c_str()); 
	AppendArgTagFast(sml_Names::kParamStatsPhaseTimePreferencePhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->decision_cycle_phase_timers[PREFERENCE_PHASE])).c_str()); 
	AppendArgTagFast(sml_Names::kParamStatsPhaseTimeWorkingMemoryPhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->decision_cycle_phase_timers[WM_PHASE])).c_str()); 
	AppendArgTagFast(sml_Names::kParamStatsMonitorTimeInputPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->monitors_cpu_time[INPUT_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMonitorTimeProposePhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->monitors_cpu_time[PROPOSE_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMonitorTimeDecisionPhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->monitors_cpu_time[DECISION_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMonitorTimeApplyPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->monitors_cpu_time[APPLY_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMonitorTimeOutputPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->monitors_cpu_time[OUTPUT_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMonitorTimePreferencePhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->monitors_cpu_time[PREFERENCE_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMonitorTimeWorkingMemoryPhase,		sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->monitors_cpu_time[WM_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsInputFunctionTime,					sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->input_function_cpu_time)).c_str());
	AppendArgTagFast(sml_Names::kParamStatsOutputFunctionTime,					sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->output_function_cpu_time)).c_str());	
	AppendArgTagFast(sml_Names::kParamStatsMatchTimeInputPhase,					sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->match_cpu_time[INPUT_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMatchTimePreferencePhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->match_cpu_time[PREFERENCE_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMatchTimeWorkingMemoryPhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->match_cpu_time[WM_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMatchTimeOutputPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->match_cpu_time[OUTPUT_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMatchTimeDecisionPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->match_cpu_time[DECISION_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMatchTimeProposePhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->match_cpu_time[PROPOSE_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsMatchTimeApplyPhase,					sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->match_cpu_time[APPLY_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsOwnershipTimeInputPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->ownership_cpu_time[INPUT_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsOwnershipTimePreferencePhase,		sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->ownership_cpu_time[PREFERENCE_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsOwnershipTimeWorkingMemoryPhase,		sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->ownership_cpu_time[WM_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsOwnershipTimeOutputPhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->ownership_cpu_time[OUTPUT_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsOwnershipTimeDecisionPhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->ownership_cpu_time[DECISION_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsOwnershipTimeProposePhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->ownership_cpu_time[PROPOSE_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsOwnershipTimeApplyPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->ownership_cpu_time[APPLY_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsChunkingTimeInputPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->chunking_cpu_time[INPUT_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsChunkingTimePreferencePhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->chunking_cpu_time[PREFERENCE_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsChunkingTimeWorkingMemoryPhase,		sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->chunking_cpu_time[WM_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsChunkingTimeOutputPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->chunking_cpu_time[OUTPUT_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsChunkingTimeDecisionPhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->chunking_cpu_time[DECISION_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsChunkingTimeProposePhase,			sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->chunking_cpu_time[PROPOSE_PHASE])).c_str());
	AppendArgTagFast(sml_Names::kParamStatsChunkingTimeApplyPhase,				sml_Names::kTypeDouble, lexical_cast< std::string >(timer_value(&m_pAgentSoar->chunking_cpu_time[APPLY_PHASE])).c_str());
