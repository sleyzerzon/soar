...
//typedef stdext::hash_map<xmlStringConst, xmlStringConst, stdext::hash_compare<xmlStringConst, strCompareElementXMLImpl>, boost::fast_pool_allocator< std::pair< xmlStringConst, xmlStringConst >, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex > >	xmlAttributeMap ;
typedef std::map<xmlStringConst, xmlStringConst, strCompareElementXMLImpl, boost::fast_pool_allocator< std::pair< xmlStringConst, xmlStringConst >, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex > >	xmlAttributeMap ;
//typedef std::map<xmlStringConst, xmlStringConst, strCompareElementXMLImpl, boost::fast_pool_allocator< std::pair< xmlStringConst, xmlStringConst > > >	xmlAttributeMap ;
...
struct ElementXMLImplTag { }; // just used to distinguish pools
typedef boost::singleton_pool<ElementXMLImplTag, sizeof(soarxml::ElementXMLImpl)> ElementXMLImplPool;

inline void* soarxml::ElementXMLImpl::operator new (size_t /*size*/)
{
	void * p = ElementXMLImplPool::malloc();
	return p;
}
inline void soarxml::ElementXMLImpl::operator delete (void *p){	
	ElementXMLImplPool::free(p);
}
