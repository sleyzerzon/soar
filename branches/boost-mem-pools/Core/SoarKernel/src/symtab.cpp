...
inline unsigned long compress (unsigned long h, short num_bits) {
...
inline unsigned long hash_string (const char *s) {   /* AGR 600 */
  unsigned long h;
...
inline unsigned long hash_variable_raw_info (char *name, short num_bits) {
  return compress (hash_string(name), num_bits);
}

inline unsigned long hash_identifier_raw_info (char name_letter,
                                        unsigned long name_number,
                                        short num_bits) {
  return compress (name_number | (name_letter << 24), num_bits);
}

inline unsigned long hash_sym_constant_raw_info (const char *name, short num_bits) {
  return compress (hash_string(name), num_bits);
}

inline unsigned long hash_int_constant_raw_info (long value, short num_bits) {
  return compress ((unsigned long)value, num_bits);
}

inline unsigned long hash_float_constant_raw_info (double value, short num_bits) {
  return compress ((unsigned long)value, num_bits);
}
