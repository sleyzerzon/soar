...
*************************************************************/
inline bool AgentSML::ConvertID(char const* pClientID, std::string* pKernelID)
{
	if (pClientID == NULL)
		return false ;
...
inline unsigned long AgentSML::ConvertTime(long clientTimeTag)
{
...
inline unsigned long AgentSML::ConvertTime(char const* pTimeTag)
{
	if (pTimeTag == NULL)
		return 0 ;
...
inline void AgentSML::RecordTime(long clientTimeTag, long kernelTimeTag)
{
...
inline void AgentSML::AddWmeToWmeMap( long clientTimeTag, wme* w ) 
{
