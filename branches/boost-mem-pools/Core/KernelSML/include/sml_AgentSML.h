...
typedef std::map< std::string, std::string, std::less<std::string> , boost::fast_pool_allocator< std::pair< std::string, std::string >, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex > >	IdentifierMap ;
...
typedef std::map< std::string, int, std::less<std::string> , boost::fast_pool_allocator< std::pair< std::string, int >, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex > >	IdentifierRefMap ;
...
typedef std::map< long, unsigned long, std::less<long> , boost::fast_pool_allocator< std::pair< long, unsigned long >, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex > >	CKTimeMap ;
...
typedef std::map< unsigned long, long, std::less<unsigned long> , boost::fast_pool_allocator< std::pair< unsigned long, long >, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex > >	KCTimeMap ;
...
typedef std::list< soarxml::ElementXML*, boost::fast_pool_allocator< soarxml::ElementXML*, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex > >	PendingInputList ;
...
typedef std::map< unsigned long, wme*, std::less<unsigned long> , boost::fast_pool_allocator< std::pair< unsigned long, wme* >, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex > >	WmeMap ;
