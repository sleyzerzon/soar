...
public:
	...
	virtual sg_node*    copy() const = 0;  // deep copy, copy doesn't inherit listeners
	...
	virtual vec3        get_trans(char type) const = 0;
...
class sg_listener {
public:
	virtual void node_update(sg_node *n, sg_node::change_type t, int added_child) = 0;
};
