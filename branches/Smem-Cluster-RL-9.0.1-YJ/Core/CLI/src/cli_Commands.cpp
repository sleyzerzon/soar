...
char const* Commands::kCLIExploration				= "exploration";
...
char const* Commands::kCLIRLcaps					= "RL";
char const* Commands::kCLIRL						= "rl";
char const* Commands::kCLIRun						= "run";
char const* Commands::kCLISaveBacktraces			= "save-backtraces";
...
char const* Commands::kCLISP						= "sp";
char const* Commands::kCLISRand						= "srand";
char const* Commands::kCLIStats						= "stats";
