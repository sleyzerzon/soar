...
public:
	smem_accessary(){last_cue_id=""; last_retrieved = NIL; last_confidence = NIL; last_experience = NIL;last_status = NIL;last_link_to_query = NIL;last_cluster_output=NIL;last_link_to_cluster_input=NIL;}
	string last_cue_id, last_cluster_input_id;
	wme *last_retrieved, *last_confidence, *last_experience, *last_status, *last_link_to_query, *last_cluster_output, *last_link_to_cluster_input;
